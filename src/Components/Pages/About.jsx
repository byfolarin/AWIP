...
const About = () => {
  ...
  return (
    <motion.div
      ...
      className='overflow-hidden font-interTight bg-[#FFFEF2] px-4 sm:px-6 lg:px-12'
    >

      <Marquee>
        <h1 className='text-[60px] sm:text-[100px] lg:text-[174px] font-medium my-32 text-[#561D0A] tracking-[-0.05em] font-interTight leading-[1.00]'>
          - About us - AWIP 
        </h1>
      </Marquee>
      ...
      <section className='px-4 sm:px-6 lg:px-12 bg-[#561D0A] text-white pt-9 rounded-tr-3xl rounded-tl-3xl'>
        ...
        <p className='pb-4 tracking-tighter text-center text-[20px] sm:text-[24px]'>ABOUT US</p>

        <div className='border-t'>
          <h2 className='font-semibold text-[24px] sm:text-[28px] lg:text-[32px] pt-5 text-center'>
        ...
        <div className='text-[16px] sm:text-[20px] py-12 w-full border-b'>
          <p className='w-full sm:w-[50%] mx-auto font-medium text-center'>
        ...
        <div className='font-medium text-[20px] sm:text-[24px] leading-tight py-24 text-center'>
