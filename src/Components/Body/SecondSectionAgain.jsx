...
const SecondSectionAgain = () => {
  ...
  return (
    ...
    <div className='w-full max-w-screen flex lg:justify-between lg:gap-11 pt-16 lg:px-8' ref={ref}>
      ...
      >
        The AWIP is a modern interpretation of typography
         found in classic architecture, traditionally etched into stone.
          This narrative reflected Little Project Co's established history,
           while maintaining a progressive focus on the future.
        <br />
        <br />
        <motion.hr
          initial={{ width: 0 }}
...
export default SecondSectionAgain
