  ...
  return (
    <div className='py-11 font-interTight px-2 lg:px-12'>
      <div className='flex flex-col lg:flex-row gap-4'>
        ...
        <div className='py-8 lg:py-16 px-4 lg:px-8 flex flex-col justify-between rounded-xl border border-white bg-[#F7F6E9]'>
          <div className='space-y-8 lg:space-y-20'>
            <h2 className='text-8xl lg:text-[134px] lg:tracking-[-0.05em] font-semibold text-[#561D0A]'>13<span className='text-black'>+</span></h2>
            <div>
        ...
        <div className='py-8 lg:py-16 px-4 lg:px-8 flex flex-col justify-between rounded-xl border border-white bg-[#F7F6E9]'>
          <div className='space-y-8 lg:space-y-20'>
            <h2 className='text-8xl lg:text-[134px] text-[#561D0A] lg:tracking-[-0.05em] font-semibold'>150<span className='text-black'>+</span></h2>
            <div>
